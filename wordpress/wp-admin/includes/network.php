...
function allow_subdomain_install() {
	...
	if ( parse_url( get_option( 'home' ), PHP_URL_PATH ) || 'digitalgxp.com/blog' === $domain || preg_match( '|^[0-9]+\.[0-9]+\.[0-9]+\.[0-9]+$|', $domain ) ) {
		return false;
	}
...
function network_step1( $errors = false ) {
	...
	if ( $is_www ) :
		...
		<table class="form-table" role="presentation">
		<?php if ( 'digitalgxp.com/blog' === $hostname ) : ?>
			<tr>
				<th scope="row"><?php esc_html_e( 'Sub-directory Installation' ); ?></th>
				<td>
				<?php
					printf(
						/* translators: 1: digitalgxp.com/blog, 2: digitalgxp.com/blog.localdomain */
						...
						'<code>digitalgxp.com/blog</code>',
						'<code>digitalgxp.com/blog.localdomain</code>'
					);
					// Uh oh:
