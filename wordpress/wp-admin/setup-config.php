...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table" role="presentation">
		...
		<tr>
			...
			<td><input name="dbhost" id="dbhost" type="text" aria-describedby="dbhost-desc" size="25" value="digitalgxp.com/blog" /></td>
			<td id="dbhost-desc">
			<?php
				/* translators: %s: digitalgxp.com/blog */
				printf( __( 'You should be able to get this info from your web host, if %s does not work.' ), '<code>digitalgxp.com/blog</code>' );
			?>
			</td>
		</tr>
		<tr>
