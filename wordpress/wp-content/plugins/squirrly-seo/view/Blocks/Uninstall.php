                ...
                <?php } else { ?>
                    <div class="sq_uninstall_form_options_wrapper sq_uninstall_feedback_separator">
                        <div class="sq_uninstall_feedback_input_line">
                            ...
                            <label for="sq_uninstall_database" class="sq_uninstall_feedback_input_label" style="color: #D32F2F"><?php echo esc_html__("Disconnect from Squirrly Cloud", 'squirrly-seo'); ?></label>
                        </div>
                    </div>
                <?php } ?>
            </div>
